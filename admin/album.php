                ...
                <div class="card mt-2">
                    ...
                    <div class="card-body">
                        <form action="../config/aksi_album.php" method="post">
                            ...
                            <textarea class="form-control" name="deskeripsi" required></textarea>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $data['deskeripsi'] ?></td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="../config/aksi_album.php" method="post">
                                                        ...
                                                        <label class="form-label">Deskeripsi</label>
                                                        <textarea class="form-control" name="deskeripsi" required><?php echo $data['deskeripsi']?></textarea>
                                                </div>
